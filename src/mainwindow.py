...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.genreComboBox = QtWidgets.QComboBox(self.groupBox)
        ...
        self.genreComboBox.addItem("")
        self.genreComboBox.addItem("")
        self.kindFieldHLayout.addWidget(self.genreComboBox)
        ...
        self.publisherLabel = QtWidgets.QLabel(self.groupBox)
        self.publisherLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.publisherLineEdit = QtWidgets.QLineEdit(self.groupBox)
        self.publisherLineEdit.setObjectName("publisherLineEdit")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.publisherLineEdit)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.summaryLabel)
        self.summaryTextEdit = QtWidgets.QTextEdit(self.groupBox)
        self.summaryTextEdit.setObjectName("summaryTextEdit")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.summaryTextEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.genreComboBox.setItemText(0, _translate("MainWindow", "---"))
        self.genreComboBox.setItemText(1, _translate("MainWindow", "Biography"))
        self.genreComboBox.setItemText(2, _translate("MainWindow", "Fantastic"))
        self.genreComboBox.setItemText(3, _translate("MainWindow", "Historical"))
        self.genreComboBox.setItemText(4, _translate("MainWindow", "Detective"))
        self.genreComboBox.setItemText(5, _translate("MainWindow", "Science Fiction"))
